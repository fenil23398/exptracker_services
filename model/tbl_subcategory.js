...
var scategories = {
    ...
    getScategoriesById: function(id, scategory, callback) {
        return db.query("select * from sub_category_tbl where fk_cat_id=? and s_fk_user_email=?", [id, scategory.s_fk_user_email], callback);
    },
