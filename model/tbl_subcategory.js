...
var scategories = {
    ...
    addScategories: function(scategory, callback) {
        return db.query("Insert into sub_category_tbl values(?,?,?,?,?)", [null, scategory.sub_cat_name, scategory.fk_cat_id, scategory.icon_image, scategory.s_fk_user_email], callback);
    },
